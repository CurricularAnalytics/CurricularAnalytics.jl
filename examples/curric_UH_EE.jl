...
# term 1
c[1] = Course("US to 1877", 3, prefix = "HIST", num = "1377")
...
c[5] = Course("Chemistry", 3, prefix = "CHEM", num = "1331")
c[6] = Course("Chemistry Lab", 1, prefix = "CHEM", num = "1111")
# term 2
...
# term 4
c[19] = Course("ENGI 2304", 3, prefix = "ENGI", num = "2304")
c[20] = Course("ECE 3331", 3, prefix = "ECE", num = "3331")
c[21] = Course("ECE 2100", 1, prefix = "ECE", num = "2100")
c[22] = Course("ECE 2202", 3, prefix = "ECE", num = "2202")
c[23] = Course("ECE 3337", 3, prefix = "ECE", num = "3337")
c[24] = Course("ECE 3436", 3, prefix = "ECE", num = "3436")
# term 5
c[25] = Course("Create Arts Core", 3)
c[26] = Course("ECE 3155", 1, prefix = "ECE", num = "3155")
c[27] = Course("ECE 3355", 3, prefix = "ECE", num = "3355")
c[28] = Course("Concentration Elective", 3)
c[29] = Course("ECE 3317", 3, prefix = "ECE", num = "3317")
c[30] = Course("ECE Elective", 3)
# term 6
c[31] = Course("POLS 1337", 3, prefix = "POLS", num = "1337")
c[32] = Course("INDE 2333", 3, prefix = "INDE", num = "2333")
c[33] = Course("Elective Lab", 1)
c[34] = Course("Concentration Elective", 3)
c[35] = Course("ECE 3340", 3, prefix = "ECE", num = "3340")
c[36] = Course("ECE Elective", 3)
# term 7
c[37] = Course("ECON 2304", 3, prefix = "ECON", num = "2304")
c[38] = Course("ECE 4335", 3, prefix = "ECE", num = "4335")
...
c[44] = Course("ECE 4336", 3, prefix = "ECE", num = "4336")
