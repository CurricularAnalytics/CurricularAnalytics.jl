...
c[4] = Course("1st Yr Writing Seminar 1", 3)
c[5] = Course("PE 1", 3)
# term 2
...
c[9] = Course("1st Yr Writing Seminar 2", 3)
c[10] = Course("PE 2", 3)
# term 3
...
c[15] = Course("Liberal Studies 1", 3)
# term 4
...
c[20] = Course("Liberal Studies 2", 3)
# term 5
c[21] = Course("ECE Foundations 1", 3)
c[22] = Course("Elective 1", 3)
c[23] = Course("Outside Tech. Elective 1", 3)
c[24] = Course("Intelligent Physical Systems", 3, prefix = "ECE", num = "3400")
c[25] = Course("Liberal Studies 3", 3)
# term 6
c[26] = Course("ECE Foundations 2", 3)
c[27] = Course("ECE Foundations 3", 3)
c[28] = Course("Outside Tech. Elective 2", 3)
c[29] = Course("Elective 2", 3)
c[30] = Course("Liberal Studies 4", 3)
# term 7
c[31] = Course("ECE Elective (CDE)", 3)
c[32] = Course("ECE Elective 1", 3)
c[33] = Course("Outside Tech. Elective 3", 3)
c[34] = Course("Liberal Studies 5", 3)
# term 8
c[35] = Course("ECE Elective 2", 3)
c[36] = Course("ECE Elective 3", 3)
c[37] = Course("ECE Elective 4", 3)
c[38] = Course("Liberal Studies 6", 3)
