...
# term 1
c[1] = Course("CHEM 2090", 3, prefix = "CHEM ", num = "2090")
c[2] = Course("MATH 1910", 3, prefix = "MATH", num = "1910")
c[3] = Course("ENGRI 1xxx", 3, prefix = "ENGRI", num = "1xxx")
c[4] = Course("1st Yr Writing Seminar", 3)
c[5] = Course("PE", 3)
# term 2
c[6] = Course("PHYS 1112", 3, prefix = "PHYS", num = "1112")
c[7] = Course("MATH 1920", 3, prefix = "MATH", num = "1920")
c[8] = Course("CS 111x", 3, prefix = "CS", num = "111x")
c[9] = Course("1st Yr Writing Seminar", 3)
c[10] = Course("PE", 3)
# term 3
c[11] = Course("PHYS 2213", 3, prefix = "PHYS", num = "2213")
c[12] = Course("MATH 2930", 3, prefix = "MATH", num = "2930")
c[13] = Course("ECE/ENGRD 2100", 3, prefix = "ECE/ENGRD", num = "2100")
c[14] = Course("MECE/ENGRD 2300", 3, prefix = "MECE/ENGRD", num = "2300")
c[15] = Course("Liberal Studies", 3)
# term 4
c[16] = Course("PHYS 2214", 3, prefix = "PHYS", num = "2214")
c[17] = Course("MATH 2940", 3, prefix = "MATH", num = "2940")
c[18] = Course("ENGRD 2xxx",3, prefix = "ENGRD", num = "2xxx")
c[19] = Course("ECE 2200/ENGRD 2220", 3, prefix = "ECE/ENGRD", num = "2200/2220")
c[20] = Course("Liberal Studies", 3)
# term 5
c[21] = Course("ECE Foundations", 3)
c[22] = Course("Elective", 3)
c[23] = Course("Outside Tech. Elective", 3)
c[24] = Course("ECE 3400", 3, prefix = "ECE", num = "3400")
